...
async function typedQueryPickupLocation(query) {
  const { httpClient, sideEffects } = arguments[1];
...
function typedQueryPickupLocation2(httpClient) {
  return (query) => typedQueryPickupLocation(
    query,
    // @ts-ignore
    { httpClient }
  );
...
function customQueryPickupLocation(httpClient) {
  const router = (0, import_query_method_router.createQueryOverloadRouter)({
    builderQueryFunction: () => queryPickupLocation3(httpClient)(),
    typedQueryFunction: (query) => typedQueryPickupLocation2(httpClient)(query),
...
var queryPickupLocation4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(customQueryPickupLocation);
