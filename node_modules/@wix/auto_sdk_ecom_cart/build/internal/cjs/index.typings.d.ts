 ...
 */
declare function createCheckout(_id: string, options?: CreateCheckoutOptions): Promise<NonNullablePaths<CreateCheckoutResponse, `checkoutId`, 2> & {
 ...
 */
declare function deleteCart(_id: string): Promise<void>;
/**
