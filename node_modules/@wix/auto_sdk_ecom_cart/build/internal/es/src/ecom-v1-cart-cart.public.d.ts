...
import { AddToCartOptions, AddToCartResponse, AddToCartResponseNonNullableFields, Cart, CartCreatedEnvelope, CartDeletedEnvelope, CartNonNullableFields, CartUpdatedEnvelope, CreateCartOptions, CreateCheckoutOptions, CreateCheckoutResponse, CreateCheckoutResponseNonNullableFields, EstimateTotalsOptions, EstimateTotalsResponse, EstimateTotalsResponseNonNullableFields, GetCartByCheckoutIdResponse, GetCartByCheckoutIdResponseNonNullableFields, LineItemQuantityUpdate, RemoveBusinessLocationResponse, RemoveBusinessLocationResponseNonNullableFields, RemoveCouponResponse, RemoveCouponResponseNonNullableFields, RemoveLineItemsResponse, RemoveLineItemsResponseNonNullableFields, UpdateCartOptions, UpdateLineItemsQuantityResponse, UpdateLineItemsQuantityResponseNonNullableFields } from './ecom-v1-cart-cart.universal.js';
...
interface GetCartByCheckoutIdSignature {
     ...
     * @param - Checkout ID.
     */
    (_id: string): Promise<GetCartByCheckoutIdResponse & GetCartByCheckoutIdResponseNonNullableFields>;
}
...
interface RemoveBusinessLocationSignature {
     ...
     * @param - Cart ID.
     */
    (_id: string): Promise<RemoveBusinessLocationResponse & RemoveBusinessLocationResponseNonNullableFields>;
}
