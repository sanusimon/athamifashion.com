...
var V1JurisdictionType = /* @__PURE__ */ ((V1JurisdictionType2) => {
  V1JurisdictionType2["UNDEFINED"] = "UNDEFINED";
  V1JurisdictionType2["COUNTRY"] = "COUNTRY";
  V1JurisdictionType2["STATE"] = "STATE";
  V1JurisdictionType2["COUNTY"] = "COUNTY";
  V1JurisdictionType2["CITY"] = "CITY";
  V1JurisdictionType2["SPECIAL"] = "SPECIAL";
  return V1JurisdictionType2;
})(V1JurisdictionType || {});
...
var V1ChargeType = /* @__PURE__ */ ((V1ChargeType2) => {
  V1ChargeType2["HANDLING_FEE"] = "HANDLING_FEE";
  V1ChargeType2["INSURANCE"] = "INSURANCE";
...
var AdditionalFeeAdditionalFeeSource = /* @__PURE__ */ ((AdditionalFeeAdditionalFeeSource2) => {
  ...
  AdditionalFeeAdditionalFeeSource2["ITEM"] = "ITEM";
  AdditionalFeeAdditionalFeeSource2["MANUAL"] = "MANUAL";
  AdditionalFeeAdditionalFeeSource2["SHIPPING"] = "SHIPPING";
  AdditionalFeeAdditionalFeeSource2["PLATFORM"] = "PLATFORM";
  return AdditionalFeeAdditionalFeeSource2;
...
var V1PaymentOption = /* @__PURE__ */ ((V1PaymentOption2) => {
  V1PaymentOption2["UNKNOWN_PAYMENT_OPTION"] = "UNKNOWN_PAYMENT_OPTION";
  V1PaymentOption2["MANUAL"] = "MANUAL";
  return V1PaymentOption2;
})(V1PaymentOption || {});
...
// src/interfaces-ecommerce-v1-payment-settings-provider.public.ts
...
var provideHandlers = (0, import_sdk_types.ServicePluginDefinition)("ECOM_PAYMENT_SETTINGS", [
  {
    ...
    transformations: {
      ...
      fromREST: (payload) => {
        const fromRestRequest = (0, import_transform_paths.transformPaths)(payload, [
          {
    ...
    transformations: {
      ...
      fromREST: (payload) => {
        const fromRestRequest = (0, import_transform_paths.transformPaths)(payload, [
          ...
          {
            transformFn: import_page_url_v2.transformRESTPageURLV2ToSDKPageURLV2,
...
// src/interfaces-ecommerce-v1-payment-settings-provider.context.ts
