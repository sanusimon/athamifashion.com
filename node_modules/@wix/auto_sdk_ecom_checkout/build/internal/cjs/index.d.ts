...
interface GetWixCheckoutUrlSignature {
     ...
     * @param - Checkout ID.
     */
    (_id: string): Promise<NonNullablePaths<GetWixCheckoutURLResponse, `checkoutUrl`, 2>>;
}
...
interface GetCheckoutPaymentSettingsSignature {
    /** @param - Checkout ID. */
    (_id: string): Promise<NonNullablePaths<GetCheckoutPaymentSettingsResponse, `blockedPaymentOptions`, 2>>;
}
...
/** @internal */
declare const getWixCheckoutUrl: MaybeContext<BuildRESTFunction<typeof getWixCheckoutUrl$1> & typeof getWixCheckoutUrl$1>;
