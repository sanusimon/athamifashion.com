...
import { AddToCheckoutOptions, AddToCheckoutResponse, AddToCheckoutResponseNonNullableFields, Checkout, CheckoutCompletedEnvelope, CheckoutCreatedEnvelope, CheckoutNonNullableFields, CheckoutUpdatedEnvelope, CreateCheckoutOptions, CreateOrderAndChargeOptions, CreateOrderAndChargeResponse, CreateOrderAndChargeResponseNonNullableFields, CreateOrderOptions, CreateOrderResponse, CreateOrderResponseNonNullableFields, GetCheckoutByCartIdResponse, GetCheckoutByCartIdResponseNonNullableFields, GetCheckoutPaymentSettingsResponse, GetCheckoutPaymentSettingsResponseNonNullableFields, GetCheckoutURLResponse, GetCheckoutURLResponseNonNullableFields, GetWixCheckoutURLResponse, GetWixCheckoutURLResponseNonNullableFields, LineItemQuantityUpdate, RemoveCouponResponse, RemoveCouponResponseNonNullableFields, RemoveGiftCardResponse, RemoveGiftCardResponseNonNullableFields, RemoveLineItemsResponse, RemoveLineItemsResponseNonNullableFields, RemoveOverrideCheckoutUrlResponse, RemoveOverrideCheckoutUrlResponseNonNullableFields, UpdateCheckout, UpdateCheckoutOptions, UpdateLineItemsQuantityResponse, UpdateLineItemsQuantityResponseNonNullableFields } from './ecom-v1-checkout-checkout.universal.js';
...
interface GetWixCheckoutUrlSignature {
     ...
     * @param - Checkout ID.
     */
    (_id: string): Promise<GetWixCheckoutURLResponse & GetWixCheckoutURLResponseNonNullableFields>;
}
...
interface CreateOrderAndChargeSignature {
     ...
     * @param - Checkout ID.
     */
    (_id: string, options?: CreateOrderAndChargeOptions | undefined): Promise<CreateOrderAndChargeResponse & CreateOrderAndChargeResponseNonNullableFields>;
}
