...
interface CreateOrderAndChargeSignature {
     ...
     * @param - Checkout ID.
     */
    (_id: string, options?: CreateOrderAndChargeOptions): Promise<NonNullablePaths<CreateOrderAndChargeResponse, `orderId` | `subscriptionId`, 2> & {
...
declare const createOrderAndCharge: MaybeContext<BuildRESTFunction<typeof createOrderAndCharge$1> & typeof createOrderAndCharge$1>;
