...
__export(index_exports, {
  ...
  startCollectingRequests: () => startCollectingRequests4,
  stopCollectingRequests: () => stopCollectingRequests4
});
...
async function startCollectingRequests2(appId) {
  ...
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({ appId });
...
// src/ecom-v1-back-in-stock-settings-back-in-stock-settings.public.ts
function startCollectingRequests3(httpClient) {
  return (appId) => startCollectingRequests2(
    appId,
    // @ts-ignore
    { httpClient }
  );
}
function stopCollectingRequests3(httpClient) {
  return (appId) => stopCollectingRequests2(
    appId,
    // @ts-ignore
    { httpClient }
  );
}
function getSettings3(httpClient) {
  return () => getSettings2(
    // @ts-ignore
    { httpClient }
  );
...
// src/ecom-v1-back-in-stock-settings-back-in-stock-settings.context.ts
var import_rest_modules2 = require("@wix/sdk-runtime/rest-modules");
var startCollectingRequests4 = /* @__PURE__ */ (0, import_rest_modules2.createRESTModule)(startCollectingRequests3);
var stopCollectingRequests4 = /* @__PURE__ */ (0, import_rest_modules2.createRESTModule)(stopCollectingRequests3);
var getSettings4 = /* @__PURE__ */ (0, import_rest_modules2.createRESTModule)(getSettings3);
