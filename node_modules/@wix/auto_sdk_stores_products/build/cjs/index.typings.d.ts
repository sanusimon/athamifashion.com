...
/** @enumType */
type VersionWithLiterals = Version | 'V1_CATALOG' | 'V3_CATALOG' | 'STORES_NOT_INSTALLED';
...
interface ProductsQueryBuilder {
     ...
     * @param value - Value to compare against.
     */
    ge: (propertyName: '_id' | 'name' | 'slug' | 'description' | 'sku' | 'priceData.price' | 'numericId' | 'lastUpdated' | '_createdDate', value: any) => ProductsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    gt: (propertyName: '_id' | 'name' | 'slug' | 'description' | 'sku' | 'priceData.price' | 'numericId' | 'lastUpdated' | '_createdDate', value: any) => ProductsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    le: (propertyName: '_id' | 'name' | 'slug' | 'description' | 'sku' | 'priceData.price' | 'numericId' | 'lastUpdated' | '_createdDate', value: any) => ProductsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    lt: (propertyName: '_id' | 'name' | 'slug' | 'description' | 'sku' | 'priceData.price' | 'numericId' | 'lastUpdated' | '_createdDate', value: any) => ProductsQueryBuilder;
 ...
 * @requiredField query
 */
declare function typedQueryProducts(query: ProductQuery): Promise<NonNullablePaths<QueryProductsPlatformizedResponse, `products` | `products.${number}._id` | `products.${number}.slug` | `products.${number}.productType` | `products.${number}.weightRange.minValue` | `products.${number}.weightRange.maxValue` | `products.${number}.stock.trackInventory` | `products.${number}.stock.inStock` | `products.${number}.stock.inventoryStatus` | `products.${number}.price.currency` | `products.${number}.price.discountedPrice` | `products.${number}.price.formatted.price` | `products.${number}.price.formatted.discountedPrice` | `products.${number}.costAndProfitData.formattedItemCost` | `products.${number}.costAndProfitData.profit` | `products.${number}.costAndProfitData.formattedProfit` | `products.${number}.costAndProfitData.profitMargin` | `products.${number}.pricePerUnitData.totalQuantity` | `products.${number}.pricePerUnitData.totalMeasurementUnit` | `products.${number}.pricePerUnitData.baseQuantity` | `products.${number}.pricePerUnitData.baseMeasurementUnit` | `products.${number}.media.mainMedia.mediaType` | `products.${number}.media.mainMedia.title` | `products.${number}.media.mainMedia._id` | `products.${number}.productPageUrl.base` | `products.${number}.productPageUrl.path` | `products.${number}.numericId` | `products.${number}.inventoryItemId` | `products.${number}.discount.type` | `products.${number}.discount.value` | `products.${number}.seoData.settings.preventAutoRedirect`, 6>>;
interface ProductQuerySpec extends QuerySpec {
    paging: 'offset';
    wql: [];
}
type CommonQueryWithEntityContext = Query$1<Product, ProductQuerySpec>;
type ProductQuery = {
    /**
    Pointer to page of results using offset. Cannot be used together with `cursorPaging`.
    */
 ...
 */
declare function getStoreVariant(_id: string): Promise<NonNullablePaths<GetStoreVariantResponse, `variant._id` | `variant.variantId` | `variant.productId` | `variant.variantName` | `variant.productName` | `variant.managedVariant` | `variant.sku` | `variant.stock.trackQuantity` | `variant.stock.inStock` | `variant.collectionIds` | `variant.preorderInfo.enabled`, 4>>;
/**
 ...
 */
declare function createProduct(product: NonNullablePaths<Product, `costAndProfitData.itemCost` | `name` | `priceData` | `priceData.price`, 3>): Promise<NonNullablePaths<CreateProductResponse, `product._id` | `product.slug` | `product.productType` | `product.weightRange.minValue` | `product.weightRange.maxValue` | `product.stock.trackInventory` | `product.stock.inStock` | `product.stock.inventoryStatus` | `product.price.currency` | `product.price.discountedPrice` | `product.price.formatted.price` | `product.price.formatted.discountedPrice` | `product.costAndProfitData.formattedItemCost` | `product.costAndProfitData.profit` | `product.costAndProfitData.formattedProfit` | `product.costAndProfitData.profitMargin` | `product.pricePerUnitData.totalQuantity` | `product.pricePerUnitData.totalMeasurementUnit` | `product.pricePerUnitData.baseQuantity` | `product.pricePerUnitData.baseMeasurementUnit` | `product.additionalInfoSections` | `product.additionalInfoSections.${number}.title` | `product.additionalInfoSections.${number}.description` | `product.ribbons` | `product.ribbons.${number}.text` | `product.media.mainMedia.image.url` | `product.media.mainMedia.image.width` | `product.media.mainMedia.image.height` | `product.media.mainMedia.video.files` | `product.media.mainMedia.video.stillFrameMediaId` | `product.media.mainMedia.mediaType` | `product.media.mainMedia.title` | `product.media.mainMedia._id` | `product.media.items` | `product.customTextFields` | `product.customTextFields.${number}.title` | `product.customTextFields.${number}.maxLength` | `product.customTextFields.${number}.mandatory` | `product.productOptions` | `product.productOptions.${number}.optionType` | `product.productOptions.${number}.name` | `product.productPageUrl.base` | `product.productPageUrl.path` | `product.numericId` | `product.inventoryItemId` | `product.discount.type` | `product.discount.value` | `product.collectionIds` | `product.variants` | `product.variants.${number}._id` | `product.variants.${number}.variant.weight` | `product.variants.${number}.variant.sku` | `product.variants.${number}.variant.visible` | `product.variants.${number}.stock.trackQuantity` | `product.variants.${number}.stock.inStock` | `product.seoData.tags` | `product.seoData.tags.${number}.type` | `product.seoData.tags.${number}.children` | `product.seoData.tags.${number}.custom` | `product.seoData.tags.${number}.disabled` | `product.seoData.settings.preventAutoRedirect` | `product.seoData.settings.keywords` | `product.seoData.settings.keywords.${number}.term` | `product.seoData.settings.keywords.${number}.isMain`, 7>>;
/**
 ...
 */
declare function updateProductVariants(_id: string, variants: VariantOverride[]): Promise<NonNullablePaths<UpdateVariantsResponse, `variants` | `variants.${number}._id` | `variants.${number}.variant.priceData.currency` | `variants.${number}.variant.priceData.discountedPrice` | `variants.${number}.variant.costAndProfitData.formattedItemCost` | `variants.${number}.variant.costAndProfitData.profit` | `variants.${number}.variant.costAndProfitData.formattedProfit` | `variants.${number}.variant.costAndProfitData.profitMargin` | `variants.${number}.variant.weight` | `variants.${number}.variant.sku` | `variants.${number}.variant.visible` | `variants.${number}.stock.trackQuantity` | `variants.${number}.stock.inStock`, 6>>;
/**
 ...
 */
declare function addProductMediaToChoices(_id: string, media: NonNullablePaths<MediaAssignmentToChoice, `choice` | `option`, 2>[]): Promise<void>;
/**
