...
import { AddDeliveryCarrierOptions, AddDeliveryCarrierResponse, AddDeliveryCarrierResponseNonNullableFields, AddDeliveryRegionOptions, AddDeliveryRegionResponse, AddDeliveryRegionResponseNonNullableFields, DeliveryProfile, DeliveryProfileNonNullableFields, DeliveryProfilesQueryBuilder, DeliveryRegion, ListDeliveryCarrierDetailsResponse, ListDeliveryCarrierDetailsResponseNonNullableFields, ListDeliveryCarriersOptions, ListDeliveryCarriersResponse, ListDeliveryCarriersResponseNonNullableFields, ListInstalledDeliveryCarriersResponse, ListInstalledDeliveryCarriersResponseNonNullableFields, RemoveDeliveryCarrierOptions, RemoveDeliveryCarrierResponse, RemoveDeliveryCarrierResponseNonNullableFields, RemoveDeliveryRegionIdentifiers, RemoveDeliveryRegionOptions, RemoveDeliveryRegionResponse, RemoveDeliveryRegionResponseNonNullableFields, UpdateCarrierSettingsOptions, UpdateDeliveryCarrierOptions, UpdateDeliveryCarrierResponse, UpdateDeliveryCarrierResponseNonNullableFields, UpdateDeliveryProfile, UpdateDeliveryRegion, UpdateDeliveryRegionIdentifiers, UpdateDeliveryRegionOptions, UpdateDeliveryRegionResponse, UpdateDeliveryRegionResponseNonNullableFields, UpdateExtendedFieldsOptions, UpdateExtendedFieldsResponse, UpdateExtendedFieldsResponseNonNullableFields } from './ecom-v1-delivery-profile-delivery-profile.universal.js';
export declare const __metadata: {
    PACKAGE_NAME: string;
};
export declare function createDeliveryProfile(httpClient: HttpClient): CreateDeliveryProfileSignature;
...
export declare function getDeliveryProfile(httpClient: HttpClient): GetDeliveryProfileSignature;
...
export declare function updateDeliveryProfile(httpClient: HttpClient): UpdateDeliveryProfileSignature;
...
export declare function deleteDeliveryProfile(httpClient: HttpClient): DeleteDeliveryProfileSignature;
...
export declare function queryDeliveryProfiles(httpClient: HttpClient): QueryDeliveryProfilesSignature;
...
export declare function updateDeliveryRegion(httpClient: HttpClient): UpdateDeliveryRegionSignature;
...
export declare function addDeliveryCarrier(httpClient: HttpClient): AddDeliveryCarrierSignature;
...
export declare function removeDeliveryCarrier(httpClient: HttpClient): RemoveDeliveryCarrierSignature;
...
export declare function updateDeliveryCarrier(httpClient: HttpClient): UpdateDeliveryCarrierSignature;
...
export declare function listDeliveryCarrierDetails(httpClient: HttpClient): ListDeliveryCarrierDetailsSignature;
...
export declare function listInstalledDeliveryCarriers(httpClient: HttpClient): ListInstalledDeliveryCarriersSignature;
interface ListInstalledDeliveryCarriersSignature {
    /** */
    (): Promise<ListInstalledDeliveryCarriersResponse & ListInstalledDeliveryCarriersResponseNonNullableFields>;
}
export declare function listDeliveryCarriers(httpClient: HttpClient): ListDeliveryCarriersSignature;
...
export declare function updateCarrierSettings(httpClient: HttpClient): UpdateCarrierSettingsSignature;
...
export { ActionEvent, AddDeliveryCarrierOptions, AddDeliveryCarrierRequest, AddDeliveryCarrierResponse, AddDeliveryCarrierResponseNonNullableFields, AddDeliveryRegionOptions, AddDeliveryRegionRequest, AddDeliveryRegionResponse, AddDeliveryRegionResponseNonNullableFields, AdditionalCharge, ApplicationError, Asset, BackupRate, BulkActionMetadata, ChargeType, Column, CreateDeliveryProfileRequest, CreateDeliveryProfileResponse, CreateDeliveryProfileResponseNonNullableFields, CreatedBy, CreatedByIdOneOf, CursorPaging, CursorPagingMetadata, CursorQuery, CursorQueryPagingMethodOneOf, Cursors, DashboardTable, DeleteContext, DeleteDeliveryProfileRequest, DeleteDeliveryProfileResponse, DeleteStatus, DeliveryCarrier, DeliveryCarrierDetails, DeliveryCarrierRegionalSettings, DeliveryProfile, DeliveryProfileNonNullableFields, DeliveryProfilesQueryBuilder, DeliveryProfilesQueryResult, DeliveryRegion, DeliveryRegionAdded, DeliveryRegionRemoved, DeliveryRegionUpdated, Destination, DestinationScope, DomainEvent, DomainEventBodyOneOf, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, ExtendedFields, GetDeliveryProfileRequest, GetDeliveryProfileResponse, GetDeliveryProfileResponseNonNullableFields, IdentificationData, IdentificationDataIdOneOf, InstalledDeliveryCarrier, ItemMetadata, ListDeliveryCarrierDetailsRequest, ListDeliveryCarrierDetailsResponse, ListDeliveryCarrierDetailsResponseNonNullableFields, ListDeliveryCarriersOptions, ListDeliveryCarriersRequest, ListDeliveryCarriersResponse, ListDeliveryCarriersResponseNonNullableFields, ListDeliveryCarriersResult, ListDeliveryDestinationsRequest, ListDeliveryDestinationsResponse, ListInstalledDeliveryCarriersRequest, ListInstalledDeliveryCarriersResponse, ListInstalledDeliveryCarriersResponseNonNullableFields, MessageEnvelope, MetaSiteSpecialEvent, MetaSiteSpecialEventPayloadOneOf, Namespace, NamespaceChanged, QueryDeliveryProfilesRequest, QueryDeliveryProfilesResponse, QueryDeliveryProfilesResponseNonNullableFields, RemoveDeliveryCarrierOptions, RemoveDeliveryCarrierRequest, RemoveDeliveryCarrierResponse, RemoveDeliveryCarrierResponseNonNullableFields, RemoveDeliveryRegionIdentifiers, RemoveDeliveryRegionOptions, RemoveDeliveryRegionRequest, RemoveDeliveryRegionResponse, RemoveDeliveryRegionResponseNonNullableFields, RequiredZipcodeRequest, RequiredZipcodeResponse, RestoreInfo, Row, ServiceProvisioned, ServiceRemoved, SiteCreated, SiteCreatedContext, SiteDeleted, SiteHardDeleted, SiteMarkedAsTemplate, SiteMarkedAsWixSite, SitePublished, SiteRenamed, SiteTransferred, SiteUndeleted, SiteUnpublished, SortOrder, Sorting, State, StudioAssigned, StudioUnassigned, UpdateCarrierSettingsOptions, UpdateCarrierSettingsRequest, UpdateCarrierSettingsResponse, UpdateDeliveryCarrierOptions, UpdateDeliveryCarrierRequest, UpdateDeliveryCarrierResponse, UpdateDeliveryCarrierResponseNonNullableFields, UpdateDeliveryProfile, UpdateDeliveryProfileRequest, UpdateDeliveryProfileResponse, UpdateDeliveryProfileResponseNonNullableFields, UpdateDeliveryRegion, UpdateDeliveryRegionIdentifiers, UpdateDeliveryRegionOptions, UpdateDeliveryRegionRequest, UpdateDeliveryRegionResponse, UpdateDeliveryRegionResponseNonNullableFields, UpdateExtendedFieldsOptions, UpdateExtendedFieldsRequest, UpdateExtendedFieldsResponse, UpdateExtendedFieldsResponseNonNullableFields, WebhookIdentityType, } from './ecom-v1-delivery-profile-delivery-profile.universal.js';
