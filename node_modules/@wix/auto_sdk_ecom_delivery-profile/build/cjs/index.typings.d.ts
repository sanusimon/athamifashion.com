...
interface DeliveryProfilesQueryBuilder {
     ...
     * @documentationMaturity preview
     */
    eq: (propertyName: '_id' | 'name' | 'default' | 'createdBy' | 'createdBy.appId' | 'createdBy.userId' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    ne: (propertyName: '_id' | 'name' | 'default' | 'createdBy' | 'createdBy.appId' | 'createdBy.userId' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    ge: (propertyName: '_id' | 'name' | 'createdBy.appId' | 'createdBy.userId' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    gt: (propertyName: '_id' | 'name' | 'createdBy.appId' | 'createdBy.userId' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    le: (propertyName: '_id' | 'name' | 'createdBy.appId' | 'createdBy.userId' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    lt: (propertyName: '_id' | 'name' | 'createdBy.appId' | 'createdBy.userId' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `string`.
     * @param string - String to compare against. Case-insensitive.
     * @documentationMaturity preview
     */
    startsWith: (propertyName: '_id' | 'name' | 'createdBy.appId' | 'createdBy.userId', value: string) => DeliveryProfilesQueryBuilder;
    /** @param propertyName - Property whose value is compared with `values`.
     * @param values - List of values to compare against.
     * @documentationMaturity preview
     */
    hasSome: (propertyName: '_id' | 'name' | 'default' | 'createdBy' | 'createdBy.appId' | 'createdBy.userId' | '_createdDate' | '_updatedDate', value: any[]) => DeliveryProfilesQueryBuilder;
    /** @documentationMaturity preview */
    in: (propertyName: '_id' | 'name' | 'default' | 'createdBy' | 'createdBy.appId' | 'createdBy.userId' | '_createdDate' | '_updatedDate', value: any) => DeliveryProfilesQueryBuilder;
    /** @documentationMaturity preview */
    exists: (propertyName: '_id' | 'name' | 'default' | 'createdBy' | 'createdBy.appId' | 'createdBy.userId' | '_createdDate' | '_updatedDate', value: boolean) => DeliveryProfilesQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments.
     * @documentationMaturity preview
     */
    ascending: (...propertyNames: Array<'_id' | 'name' | 'default' | 'createdBy' | 'createdBy.appId' | 'createdBy.userId' | '_createdDate' | '_updatedDate'>) => DeliveryProfilesQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments.
     * @documentationMaturity preview
     */
    descending: (...propertyNames: Array<'_id' | 'name' | 'default' | 'createdBy' | 'createdBy.appId' | 'createdBy.userId' | '_createdDate' | '_updatedDate'>) => DeliveryProfilesQueryBuilder;
 ...
 */
declare function addDeliveryRegion(deliveryProfileId: string, deliveryRegion: NonNullablePaths<DeliveryRegion, `destinations.${number}.countryCode` | `name`, 4>, options?: AddDeliveryRegionOptions): Promise<NonNullablePaths<AddDeliveryRegionResponse, `deliveryProfile.deliveryRegions`, 3> & {
 ...
 */
declare function updateDeliveryRegion(identifiers: NonNullablePaths<UpdateDeliveryRegionIdentifiers, `deliveryProfileId` | `deliveryRegionId`, 2>, deliveryRegion: UpdateDeliveryRegion, options?: UpdateDeliveryRegionOptions): Promise<NonNullablePaths<UpdateDeliveryRegionResponse, `deliveryProfile.deliveryRegions`, 3> & {
 ...
 */
declare function removeDeliveryRegion(identifiers: NonNullablePaths<RemoveDeliveryRegionIdentifiers, `deliveryProfileId` | `deliveryRegionId`, 2>, options?: RemoveDeliveryRegionOptions): Promise<NonNullablePaths<RemoveDeliveryRegionResponse, `deliveryProfile.deliveryRegions`, 3> & {
 ...
 */
declare function removeDeliveryCarrier(deliveryRegionId: string, options: NonNullablePaths<RemoveDeliveryCarrierOptions, `appId`, 2>): Promise<NonNullablePaths<RemoveDeliveryCarrierResponse, `deliveryProfile.deliveryRegions`, 3> & {
 ...
 */
declare function updateDeliveryCarrier(deliveryRegionId: string, options?: NonNullablePaths<UpdateDeliveryCarrierOptions, `deliveryCarrier.appId`, 3>): Promise<NonNullablePaths<UpdateDeliveryCarrierResponse, `deliveryProfile.deliveryRegions`, 3> & {
 ...
 */
declare function updateExtendedFields(_id: string, namespace: string, options: NonNullablePaths<UpdateExtendedFieldsOptions, `namespaceData`, 2>): Promise<NonNullablePaths<UpdateExtendedFieldsResponse, `deliveryProfile.deliveryRegions`, 3>>;
