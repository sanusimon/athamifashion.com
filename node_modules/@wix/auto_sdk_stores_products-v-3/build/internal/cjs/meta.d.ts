import { hx as CreateProductRequest$1, hy as CreateProductResponse$1, hD as CreateProductWithInventoryRequest$1, d as CreateProductWithInventoryResponse$1, hI as UpdateProductRequest$1, hJ as UpdateProductResponse$1, hK as UpdateProductWithInventoryRequest$1, l as UpdateProductWithInventoryResponse$1, hL as BulkCreateProductsRequest$1, o as BulkCreateProductsResponse$1, hP as BulkCreateProductsWithInventoryRequest$1, s as BulkCreateProductsWithInventoryResponse$1, hR as BulkUpdateProductsRequest$1, x as BulkUpdateProductsResponse$1, hS as BulkUpdateProductsWithInventoryRequest$1, D as BulkUpdateProductsWithInventoryResponse$1, hT as V3BulkUpdateProductsByFilterRequest$1, H as V3BulkUpdateProductsByFilterResponse$1, hV as V3DeleteProductRequest$1, hW as V3DeleteProductResponse$1, hX as V3BulkDeleteProductsRequest$1, K as V3BulkDeleteProductsResponse$1, hZ as V3BulkDeleteProductsByFilterRequest$1, O as V3BulkDeleteProductsByFilterResponse$1, h_ as V3GetProductRequest$1, h$ as V3GetProductResponse$1, i0 as V3GetProductBySlugRequest$1, T as V3GetProductBySlugResponse$1, i1 as V3SearchProductsRequest$1, Z as V3SearchProductsResponse$1, iH as V3QueryProductsRequest$1, iK as V3QueryProductsResponse$1, iL as V3CountProductsRequest$1, a0 as V3CountProductsResponse$1, iM as BulkUpdateProductVariantsByFilterRequest$1, a3 as BulkUpdateProductVariantsByFilterResponse$1, iN as V3BulkAdjustProductVariantsByFilterRequest$1, a7 as V3BulkAdjustProductVariantsByFilterResponse$1, iS as V3BulkAddInfoSectionsToProductsByFilterRequest$1, ab as V3BulkAddInfoSectionsToProductsByFilterResponse$1, iT as V3BulkAddInfoSectionsToProductsRequest$1, af as V3BulkAddInfoSectionsToProductsResponse$1, iU as V3BulkRemoveInfoSectionsFromProductsByFilterRequest$1, ai as V3BulkRemoveInfoSectionsFromProductsByFilterResponse$1, iV as V3BulkRemoveInfoSectionsFromProductsRequest$1, ak as V3BulkRemoveInfoSectionsFromProductsResponse$1, iW as BulkAddProductsToCategoriesByFilterRequest$1, am as BulkAddProductsToCategoriesByFilterResponse$1, iX as BulkRemoveProductsFromCategoriesByFilterRequest$1, ao as BulkRemoveProductsFromCategoriesByFilterResponse$1, iY as GetAllProductsCategoryRequest$1, ap as GetAllProductsCategoryResponse$1 } from './stores-catalog-v3-product-products-v-3.universal-C6S66Ol_.js';
...
interface MigrationBulkCreateProductsRequest {
    /**
     * List of products to be created.
     * @minSize 1
     * @maxSize 100
...
interface MigrationBulkCreateProductsResponse {
    /**
     * Products created by bulk action.
     * @minSize 1
     * @maxSize 100
...
interface WixCommonBulkActionMetadata {
    /** Number of items that were successfully processed. */
    totalSuccesses?: number;
    /** Number of items that couldn't be processed. */
    totalFailures?: number;
...
interface UpstreamWixCommonItemMetadata {
    /**
     * Item ID. Should always be available, unless it's impossible (for example, when failing to create an item).
     * @minLength 1
     * @maxLength 36
