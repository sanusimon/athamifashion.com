...
export function createLocalDeliveryOption(payload) {
...
export function getLocalDeliveryOption(payload) {
...
export function listLocalDeliveryOptions(payload) {
 ...
 */
export function queryLocalDeliveryOptions(payload) {
...
export function updateLocalDeliveryOption(payload) {
...
export function deleteLocalDeliveryOption(payload) {
...
export function bulkCreateLocalDeliveryOption(payload) {
...
export function bulkUpdateLocalDeliveryOption(payload) {
...
export function bulkDeleteLocalDeliveryOption(payload) {
...
//# sourceMappingURL=ecom-v1-local-delivery-option-local-delivery-options.http.js.map