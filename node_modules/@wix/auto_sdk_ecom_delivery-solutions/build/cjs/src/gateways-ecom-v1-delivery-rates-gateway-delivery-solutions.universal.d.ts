 ...
 */
export declare function getDeliverySolutions(lineItems: DeliverableItem[], options?: GetDeliverySolutionsOptions): Promise<GetDeliverySolutionsResponse & GetDeliverySolutionsResponseNonNullableFields>;
