...
__export(index_exports, {
  ...
  getDeliverySolutions: () => getDeliverySolutions4
});
module.exports = __toCommonJS(index_exports);

// src/gateways-ecom-v1-delivery-rates-gateway-delivery-solutions.universal.ts
var import_transform_error = require("@wix/sdk-runtime/transform-error");
var import_rename_all_nested_keys = require("@wix/sdk-runtime/rename-all-nested-keys");

// src/gateways-ecom-v1-delivery-rates-gateway-delivery-solutions.http.ts
...
var PACKAGE_NAME = "@wix/auto_sdk_ecom_delivery-solutions";
...
async function getDeliverySolutions2(lineItems, options) {
  ...
  const reqOpts = getDeliverySolutions(
    payload
  );
...
// src/gateways-ecom-v1-delivery-rates-gateway-delivery-solutions.public.ts
function getDeliverySolutions3(httpClient) {
  return (lineItems, options) => getDeliverySolutions2(
    lineItems,
    options,
    // @ts-ignore
    { httpClient }
...
// src/gateways-ecom-v1-delivery-rates-gateway-delivery-solutions.context.ts
var import_rest_modules2 = require("@wix/sdk-runtime/rest-modules");
var getDeliverySolutions4 = /* @__PURE__ */ (0, import_rest_modules2.createRESTModule)(getDeliverySolutions3);
