...
__export(index_exports, {
  ...
  MembershipCannotBeUsedWixError: () => MembershipCannotBeUsedWixError,
  MembershipDoesNotApplyToItemWixError: () => MembershipDoesNotApplyToItemWixError,
  MembershipErrorType: () => MembershipErrorType,
  TransactionAlreadyVoidedWixError: () => TransactionAlreadyVoidedWixError,
  TransactionCannotBeVoidedWixError: () => TransactionCannotBeVoidedWixError,
...
var provideHandlers = (0, import_sdk_types.ServicePluginDefinition)("ECOM_MEMBERSHIPS", [
  {
    name: "listEligibleMemberships",
    primaryHttpMappingPath: "/v1/list-eligible-memberships",
    transformations: {
      toREST: (payload) => {
        const toRestResponse = (0, import_transform_paths.transformPaths)(payload, [
          {
