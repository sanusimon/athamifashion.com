import { GetCheckoutSettingsRequest as GetCheckoutSettingsRequest$1, GetCheckoutSettingsResponse as GetCheckoutSettingsResponse$1, UpdateCheckoutSettingsRequest as UpdateCheckoutSettingsRequest$1, UpdateCheckoutSettingsResponse as UpdateCheckoutSettingsResponse$1 } from './index.typings.js';
...
/** @enumType */
type DisplayTypeWithLiterals = DisplayType | 'UNKNOWN_DISPLAY_TYPE' | 'TEXT' | 'ICON';
interface BackgroundFill extends BackgroundFillOptionsOneOf {
    /**
...
/** @oneof */
interface BackgroundFillOptionsOneOf {
    /**
     * Background color hex code.
     * @format COLOR_HEX
     */
...
declare enum CheckoutBillingFields {
...
/** @enumType */
type CheckoutBillingFieldsWithLiterals = CheckoutBillingFields | 'UNKNOWN_CHECKOUT_BILLING_FIELDS' | 'All_FIELDS' | 'MINIMUM_REQUIRED_FIELDS';
...
declare function getCheckoutSettings(): __PublicMethodMetaInfo<'GET', {}, GetCheckoutSettingsRequest$1, GetCheckoutSettingsRequest, GetCheckoutSettingsResponse$1, GetCheckoutSettingsResponse>;
declare function updateCheckoutSettings(): __PublicMethodMetaInfo<'PATCH', {}, UpdateCheckoutSettingsRequest$1, UpdateCheckoutSettingsRequest, UpdateCheckoutSettingsResponse$1, UpdateCheckoutSettingsResponse>;

export { type ActionEvent as ActionEventOriginal, Alignment as AlignmentOriginal, type AlignmentWithLiterals as AlignmentWithLiteralsOriginal, type BackgroundFillOptionsOneOf as BackgroundFillOptionsOneOfOriginal, type BackgroundFill as BackgroundFillOriginal, type CheckboxField as CheckboxFieldOriginal, CheckoutBillingFields as CheckoutBillingFieldsOriginal, type CheckoutBillingFieldsWithLiterals as CheckoutBillingFieldsWithLiteralsOriginal, type CheckoutBrand as CheckoutBrandOriginal, type CheckoutFields as CheckoutFieldsOriginal, type CheckoutHeader as CheckoutHeaderOriginal, type CheckoutPolicies as CheckoutPoliciesOriginal, type CheckoutSettings as CheckoutSettingsOriginal, type ContactUsPolicy as ContactUsPolicyOriginal, type ContinueShopping as ContinueShoppingOriginal, type CustomCheckoutPolicy as CustomCheckoutPolicyOriginal, type DeleteCheckoutSettingsRequest as DeleteCheckoutSettingsRequestOriginal, type DeleteCheckoutSettingsResponse as DeleteCheckoutSettingsResponseOriginal, type DigitalItemPolicy as DigitalItemPolicyOriginal, DisplayType as DisplayTypeOriginal, type DisplayTypeWithLiterals as DisplayTypeWithLiteralsOriginal, type DomainEventBodyOneOf as DomainEventBodyOneOfOriginal, type DomainEvent as DomainEventOriginal, type Empty as EmptyOriginal, type EntityCreatedEvent as EntityCreatedEventOriginal, type EntityDeletedEvent as EntityDeletedEventOriginal, type EntityUpdatedEvent as EntityUpdatedEventOriginal, type FocalPoint as FocalPointOriginal, type GetCheckoutSettingsRequest as GetCheckoutSettingsRequestOriginal, type GetCheckoutSettingsResponse as GetCheckoutSettingsResponseOriginal, type GiftCardProviderWasProvisioned as GiftCardProviderWasProvisionedOriginal, type IdentificationDataIdOneOf as IdentificationDataIdOneOfOriginal, type IdentificationData as IdentificationDataOriginal, type Image as ImageOriginal, type ListCheckoutSettingsRequest as ListCheckoutSettingsRequestOriginal, type ListCheckoutSettingsResponse as ListCheckoutSettingsResponseOriginal, type Logo as LogoOriginal, LogoSize as LogoSizeOriginal, type LogoSizeWithLiterals as LogoSizeWithLiteralsOriginal, type MessageEnvelope as MessageEnvelopeOriginal, type PrivacyPolicy as PrivacyPolicyOriginal, type RestoreInfo as RestoreInfoOriginal, type ReturnPolicy as ReturnPolicyOriginal, type TermsAndConditionsPolicy as TermsAndConditionsPolicyOriginal, type UpdateCheckoutSettingsRequest as UpdateCheckoutSettingsRequestOriginal, type UpdateCheckoutSettingsResponse as UpdateCheckoutSettingsResponseOriginal, WebhookIdentityType as WebhookIdentityTypeOriginal, type WebhookIdentityTypeWithLiterals as WebhookIdentityTypeWithLiteralsOriginal, type __PublicMethodMetaInfo, getCheckoutSettings, updateCheckoutSettings };
