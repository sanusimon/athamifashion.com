 ...
 * @targetRemovalDate 2024-03-31
 */
declare function getAbandonedCart(_id: string): Promise<NonNullablePaths<AbandonedCart, `_id` | `status` | `buyerInfo._id` | `buyerInfo.identityType` | `activities` | `activities.${number}.activityType`, 4>>;
/**
 ...
 * @targetRemovalDate 2024-03-31
 */
declare function queryAbandonedCarts(options?: QueryAbandonedCartsOptions): Promise<NonNullablePaths<QueryAbandonedCartsResponse, `abandonedCarts` | `abandonedCarts.${number}._id` | `abandonedCarts.${number}.status` | `abandonedCarts.${number}.buyerInfo._id` | `abandonedCarts.${number}.buyerInfo.identityType` | `totalResults`, 5>>;
interface QueryAbandonedCartsOptions {
    /** Query details */
    query?: Query;
}

export { type AbandonedCart, type AbandonedCartCartAbandonedEnvelope, type AbandonedCartCartRecoveredEnvelope, type Activity, ActivityType, type ActivityTypeWithLiterals, type BaseEventMetadata, type BuyerInfo, type CartAbandonedEvent, type CartDeletedEvent, type CartRecoveredEvent, type CustomData, type DeleteCartRequest, type DeleteCartResponse, type GetAbandonedCartRequest, type GetAbandonedCartResponse, type HeadersEntry, type IdentificationData, type IdentificationDataIdOneOf, Identity, type IdentityWithLiterals, type MessageEnvelope, type Paging, type Query, type QueryAbandonedCartsOptions, type QueryAbandonedCartsRequest, type QueryAbandonedCartsResponse, type RawHttpResponse, type RedirectToCheckoutRequest, Status, type StatusWithLiterals, type Totals, WebhookIdentityType, type WebhookIdentityTypeWithLiterals, getAbandonedCart, onAbandonedCartCartAbandonedEvent, onAbandonedCartCartRecoveredEvent, queryAbandonedCarts };
