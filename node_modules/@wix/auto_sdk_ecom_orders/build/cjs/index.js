...
async function preparePaymentCollection2(ecomOrderId, amount, options) {
  ...
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    ...
    merchantInitiated: options?.merchantInitiated,
    ...
    const transformedError = (0, import_transform_error.transformError)(
      err,
      {
        ...
        explicitPathsToArguments: {
          ...
          merchantInitiated: "$[2].merchantInitiated",
          redirectUrls: "$[2].redirectUrls",
...
function addActivities3(httpClient) {
  return (orderId, options) => addActivities2(
    orderId,
    options,
    // @ts-ignore
    { httpClient }
...
var onOrderPaymentStatusUpdated2 = (0, import_event_definition_modules.createEventModule)(
