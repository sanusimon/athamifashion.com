...
__export(meta_exports, {
  ...
  ItemAvailabilityStatusOriginal: () => ItemAvailabilityStatus,
  ItemTypePresetOriginal: () => ItemTypePreset,
  JurisdictionTypeOriginal: () => JurisdictionType,
  ManualCalculationReasonOriginal: () => ManualCalculationReason,
  NameInLineItemOriginal: () => NameInLineItem,
  ...
  createAndRedirectToCheckout: () => createAndRedirectToCheckout2,
  createCheckoutFromTemplate: () => createCheckoutFromTemplate2,
  createCheckoutTemplate: () => createCheckoutTemplate2,
  deleteCheckoutTemplate: () => deleteCheckoutTemplate2,
  getCheckoutTemplate: () => getCheckoutTemplate2,
  queryCheckoutTemplates: () => queryCheckoutTemplates2,
  updateCheckoutTemplate: () => updateCheckoutTemplate2
});
...
// src/ecom-v1-checkout-template-checkout-templates.types.ts
...
// src/ecom-v1-checkout-template-checkout-templates.meta.ts
function createCheckoutTemplate2() {
  const payload = {};
  const getRequestOptions = createCheckoutTemplate(payload);
...
function getCheckoutTemplate2() {
  const payload = { checkoutTemplateId: ":checkoutTemplateId" };
  const getRequestOptions = getCheckoutTemplate(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function updateCheckoutTemplate2() {
  const payload = { checkoutTemplate: { id: ":checkoutTemplateId" } };
  const getRequestOptions = updateCheckoutTemplate(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteCheckoutTemplate2() {
  const payload = { checkoutTemplateId: ":checkoutTemplateId" };
  const getRequestOptions = deleteCheckoutTemplate(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function queryCheckoutTemplates2() {
  const payload = {};
  const getRequestOptions = queryCheckoutTemplates(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function createCheckoutFromTemplate2() {
  const payload = { checkoutTemplateId: ":checkoutTemplateId" };
  const getRequestOptions = createCheckoutFromTemplate(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function createAndRedirectToCheckout2() {
  const payload = { checkoutTemplateId: ":checkoutTemplateId" };
  const getRequestOptions = createAndRedirectToCheckout(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
0 && (module.exports = {
  ...
  FileTypeOriginal,
  ItemAvailabilityStatusOriginal,
  ItemTypePresetOriginal,
  JurisdictionTypeOriginal,
  ManualCalculationReasonOriginal,
  NameInLineItemOriginal,
  NameInOtherOriginal,
