 ...
 * @slug created
 */
declare function onCheckoutTemplateCreated(handler: (event: CheckoutTemplateCreatedEnvelope) => void | Promise<void>): void;
 ...
 * @slug deleted
 */
declare function onCheckoutTemplateDeleted(handler: (event: CheckoutTemplateDeletedEnvelope) => void | Promise<void>): void;
 ...
 * @slug updated
 */
declare function onCheckoutTemplateUpdated(handler: (event: CheckoutTemplateUpdatedEnvelope) => void | Promise<void>): void;
 ...
 * @slug used
 */
declare function onCheckoutTemplateUsed(handler: (event: CheckoutTemplateUsedEnvelope) => void | Promise<void>): void;
/**
 ...
 */
declare function getCheckoutTemplate(checkoutTemplateId: string): Promise<NonNullablePaths<CheckoutTemplate, `status` | `customization.webClient.disabledContinueShoppingButton` | `customization.webClient.disabledPolicyAgreementCheckbox` | `customization.lockedGiftCard` | `customization.lockedCoupon` | `customization.disabledManualPayment` | `lineItems` | `lineItems.${number}.quantity` | `lineItems.${number}.catalogReference.catalogItemId` | `lineItems.${number}.catalogReference.appId` | `lineItems.${number}.catalogOverrideFields.productName.original` | `lineItems.${number}.catalogOverrideFields.physicalProperties.shippable` | `lineItems.${number}.catalogOverrideFields.paymentOption.value` | `customLineItems` | `customLineItems.${number}.quantity` | `customLineItems.${number}.price` | `customLineItems.${number}.priceDescription.original` | `customLineItems.${number}.itemType.preset` | `customLineItems.${number}.itemType.custom` | `customLineItems.${number}.paymentOption` | `customLineItems.${number}.priceUndetermined` | `customLineItems.${number}.fixedQuantity` | `customLineItems.${number}.savePaymentMethod` | `customLineItems.${number}.membersOnly` | `customLineItems.${number}.taxableAddress.addressType` | `customContentReference.appId` | `customContentReference.componentId` | `externalReference.appId`, 6>>;
/**
 ...
 */
declare function updateCheckoutTemplate(_id: string, checkoutTemplate: UpdateCheckoutTemplate): Promise<NonNullablePaths<CheckoutTemplate, `status` | `customization.webClient.disabledContinueShoppingButton` | `customization.webClient.disabledPolicyAgreementCheckbox` | `customization.lockedGiftCard` | `customization.lockedCoupon` | `customization.disabledManualPayment` | `lineItems` | `lineItems.${number}.quantity` | `lineItems.${number}.catalogReference.catalogItemId` | `lineItems.${number}.catalogReference.appId` | `lineItems.${number}.catalogOverrideFields.productName.original` | `lineItems.${number}.catalogOverrideFields.physicalProperties.shippable` | `lineItems.${number}.catalogOverrideFields.paymentOption.value` | `customLineItems` | `customLineItems.${number}.quantity` | `customLineItems.${number}.price` | `customLineItems.${number}.priceDescription.original` | `customLineItems.${number}.itemType.preset` | `customLineItems.${number}.itemType.custom` | `customLineItems.${number}.paymentOption` | `customLineItems.${number}.priceUndetermined` | `customLineItems.${number}.fixedQuantity` | `customLineItems.${number}.savePaymentMethod` | `customLineItems.${number}.membersOnly` | `customLineItems.${number}.taxableAddress.addressType` | `customContentReference.appId` | `customContentReference.componentId` | `externalReference.appId`, 6> & {
 ...
 */
declare function deleteCheckoutTemplate(checkoutTemplateId: string): Promise<void>;
/**
 ...
 */
declare function queryCheckoutTemplates(): CheckoutTemplatesQueryBuilder;
 ...
 * @requiredField query
 */
declare function typedQueryCheckoutTemplates(query: CheckoutTemplateQuery): Promise<NonNullablePaths<QueryCheckoutTemplatesResponse, `checkoutTemplates` | `checkoutTemplates.${number}.status` | `checkoutTemplates.${number}.customization.webClient.disabledContinueShoppingButton` | `checkoutTemplates.${number}.customization.webClient.disabledPolicyAgreementCheckbox` | `checkoutTemplates.${number}.customization.lockedGiftCard` | `checkoutTemplates.${number}.customization.lockedCoupon` | `checkoutTemplates.${number}.customization.disabledManualPayment` | `checkoutTemplates.${number}.customContentReference.appId` | `checkoutTemplates.${number}.customContentReference.componentId` | `checkoutTemplates.${number}.externalReference.appId`, 6>>;
interface CheckoutTemplateQuerySpec extends QuerySpec {
    paging: 'cursor';
    wql: [
        {
            fields: ['_id', 'status'];
...
type CommonQueryWithEntityContext = Query<CheckoutTemplate, CheckoutTemplateQuerySpec>;
type CheckoutTemplateQuery = {
    /**
    Cursor token pointing to a page of results. Not used in the first request. Following requests use the cursor token and not `filter` or `sort`.
    */
    cursorPaging?: {
