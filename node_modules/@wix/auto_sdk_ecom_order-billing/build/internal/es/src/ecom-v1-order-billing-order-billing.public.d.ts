...
import { AuthorizeChargeWithSavedPaymentMethodOptions, AuthorizeChargeWithSavedPaymentMethodResponse, AuthorizeChargeWithSavedPaymentMethodResponseNonNullableFields, CalculateRefundOptions, CalculateRefundResponse, CalculateRefundResponseNonNullableFields, CaptureAuthorizedPaymentsOptions, CaptureAuthorizedPaymentsResponse, CaptureAuthorizedPaymentsResponseNonNullableFields, GenerateReceiptsOptions, GenerateReceiptsResponse, GenerateReceiptsResponseNonNullableFields, GetOrderRefundabilityResponse, GetOrderRefundabilityResponseNonNullableFields, RefundPaymentsOptions, RefundPaymentsResponse, RefundPaymentsResponseNonNullableFields, VoidAuthorizedPaymentsOptions, VoidAuthorizedPaymentsResponse, VoidAuthorizedPaymentsResponseNonNullableFields } from './ecom-v1-order-billing-order-billing.universal.js';
...
interface GetOrderRefundabilitySignature {
     ...
     * @param - Order ID.
     */
    (orderId: string): Promise<GetOrderRefundabilityResponse & GetOrderRefundabilityResponseNonNullableFields>;
}
...
interface CalculateRefundSignature {
     ...
     * @param - Order ID.
     */
    (orderId: string, options?: CalculateRefundOptions | undefined): Promise<CalculateRefundResponse & CalculateRefundResponseNonNullableFields>;
}
...
interface RefundPaymentsSignature {
     ...
     * @param - Order ID.
     */
    (orderId: string, options?: RefundPaymentsOptions | undefined): Promise<RefundPaymentsResponse & RefundPaymentsResponseNonNullableFields>;
}
...
interface AuthorizeChargeWithSavedPaymentMethodSignature {
     ...
     */
    (orderId: string, options: AuthorizeChargeWithSavedPaymentMethodOptions): Promise<AuthorizeChargeWithSavedPaymentMethodResponse & AuthorizeChargeWithSavedPaymentMethodResponseNonNullableFields>;
}
...
interface VoidAuthorizedPaymentsSignature {
     ...
     * @param - Order ID.
     */
    (orderId: string, options: VoidAuthorizedPaymentsOptions): Promise<VoidAuthorizedPaymentsResponse & VoidAuthorizedPaymentsResponseNonNullableFields>;
}
...
interface CaptureAuthorizedPaymentsSignature {
     ...
     * @param - Order ID.
     */
    (orderId: string, options: CaptureAuthorizedPaymentsOptions): Promise<CaptureAuthorizedPaymentsResponse & CaptureAuthorizedPaymentsResponseNonNullableFields>;
}
/** @internal */
...
interface GenerateReceiptsSignature {
     ...
     * @param - Order ID.
     */
    (orderId: string, options: GenerateReceiptsOptions): Promise<GenerateReceiptsResponse & GenerateReceiptsResponseNonNullableFields>;
}
export { ActionEvent, ActionType, AdditionalFeeRefund, AdditionalFeeRefundability, AggregatedRefundSummary, ApplicationError, AuthorizationActionFailureDetails, AuthorizationCapture, AuthorizationCaptureStatus, AuthorizationDetails, AuthorizationVoid, AuthorizationVoidStatus, AuthorizeChargeWithSavedPaymentMethodOptions, AuthorizeChargeWithSavedPaymentMethodRequest, AuthorizeChargeWithSavedPaymentMethodResponse, AuthorizeChargeWithSavedPaymentMethodResponseNonNullableFields, CalculateRefundOptions, CalculateRefundRequest, CalculateRefundResponse, CalculateRefundResponseNonNullableFields, CalculateRefundResponseStatusOneOf, CalculatedAdditionalFeeRefund, CalculatedLineItemRefund, CalculatedRefundItems, CalculatedRefundNotAvailableStatus, CalculatedRefundSummary, CalculatedShippingRefund, CalculationError, CalculationErrorItemOneOf, CaptureAuthorizedPaymentsOptions, CaptureAuthorizedPaymentsRequest, CaptureAuthorizedPaymentsResponse, CaptureAuthorizedPaymentsResponseNonNullableFields, CreditCardPaymentMethodDetails, DelayedCaptureSettings, Details, DetailsKindOneOf, DomainEvent, DomainEventBodyOneOf, Duration, DurationUnit, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, ExternalReceiptInfo, FieldViolation, GenerateReceiptsOptions, GenerateReceiptsRequest, GenerateReceiptsResponse, GenerateReceiptsResponseNonNullableFields, GetOrderRefundabilityRequest, GetOrderRefundabilityResponse, GetOrderRefundabilityResponseNonNullableFields, GiftCardPaymentDetails, LineItemRefund, LineItemRefundability, ManuallyRefundablePaymentStatus, ManuallyRefundableReason, MembershipName, MembershipPaymentDetails, MembershipPaymentStatus, MembershipPaymentSummary, MonetaryPaymentSummary, NonRefundablePaymentStatus, NonRefundableReason, NotificationSideEffects, OrderBilling, OrderTransactions, Payment, PaymentCapture, PaymentInfo, PaymentInfoPaymentMethodDetailsOneOf, PaymentInfoSummaryOneOf, PaymentNotRefundableDetails, PaymentPaymentDetailsOneOf, PaymentReceiptInfoOneOf, PaymentRefund, PaymentRefundability, PaymentRefundabilityStatusOneOf, PaymentsSummary, Price, Reason, ReceiptInfo, Refund, RefundDetails, RefundItem, RefundItems, RefundPaymentsOptions, RefundPaymentsRequest, RefundPaymentsResponse, RefundPaymentsResponseNonNullableFields, RefundSideEffects, RefundStatus, RefundStatusInfo, RefundTransaction, RegularPaymentDetails, RegularPaymentDetailsPaymentMethodDetailsOneOf, RestockItem, RestockSideEffects, RestoreInfo, RuleType, ScheduledAction, ShippingRefund, ShippingRefundability, SystemError, TransactionStatus, V1AdditionalFeeRefund, V1AggregatedRefundSummary, V1LineItemRefund, V1ScheduledAction, V1ShippingRefund, ValidationError, VoidAuthorizedPaymentsOptions, VoidAuthorizedPaymentsRequest, VoidAuthorizedPaymentsResponse, VoidAuthorizedPaymentsResponseNonNullableFields, WixReceiptInfo, } from './ecom-v1-order-billing-order-billing.universal.js';
