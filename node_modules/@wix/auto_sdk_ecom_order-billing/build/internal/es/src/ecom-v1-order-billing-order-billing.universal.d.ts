...
interface ReceiptInfoNonNullableFields {
    paymentId: string;
    receiptId: string;
}
export interface GenerateReceiptsResponseNonNullableFields {
    receipts: ReceiptInfoNonNullableFields[];
}
/**
 ...
 */
export declare function generateReceipts(orderId: string, options: GenerateReceiptsOptions): Promise<GenerateReceiptsResponse & GenerateReceiptsResponseNonNullableFields>;
