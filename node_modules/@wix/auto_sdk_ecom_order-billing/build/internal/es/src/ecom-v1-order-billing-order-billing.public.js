import { authorizeChargeWithSavedPaymentMethod as universalAuthorizeChargeWithSavedPaymentMethod, calculateRefund as universalCalculateRefund, captureAuthorizedPayments as universalCaptureAuthorizedPayments, generateReceipts as universalGenerateReceipts, getOrderRefundability as universalGetOrderRefundability, refundPayments as universalRefundPayments, voidAuthorizedPayments as universalVoidAuthorizedPayments, } from './ecom-v1-order-billing-order-billing.universal.js';
...
/** @internal */
export function generateReceipts(httpClient) {
    return (orderId, options) => universalGenerateReceipts(orderId, options, 
    // @ts-ignore
    { httpClient });
}
