 ...
 */
export declare function generateInvoice(orderId: string): Promise<GenerateInvoiceResponse & GenerateInvoiceResponseNonNullableFields>;
/**
 ...
 */
export declare function bulkGenerateInvoices(orderIds: string[]): Promise<BulkGenerateInvoicesResponse & BulkGenerateInvoicesResponseNonNullableFields>;
/**
 ...
 */
export declare function addInvoiceToOrder(orderId: string, invoiceInfo: Invoice): Promise<AddInvoiceToOrderResponse & AddInvoiceToOrderResponseNonNullableFields>;
export {};
