...
__export(index_exports, {
  ...
  onOrderTransactionsChargebackApproved: () => onOrderTransactionsChargebackApproved2,
  onOrderTransactionsChargebackReversed: () => onOrderTransactionsChargebackReversed2,
...
async function updateRefundTransaction2(orderId, refundId, options) {
...
function updateRefundTransaction3(httpClient) {
  return (orderId, refundId, options) => updateRefundTransaction2(
    orderId,
    refundId,
    options,
    // @ts-ignore
...
var onOrderTransactionsChargebackApproved = (0, import_sdk_types.EventDefinition)(
  "wix.ecom.v1.order_transactions_chargeback_approved",
  true,
    ...
    (0, import_transform_paths2.transformPaths)(event, [
      {
        ...
        paths: [
          { path: "data.chargeback.createdDate" },
          { path: "data.chargeback.updatedDate" },
...
var onOrderTransactionsChargebackReversed = (0, import_sdk_types.EventDefinition)(
  "wix.ecom.v1.order_transactions_chargeback_reversed",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths2.transformPaths)(event, [
      {
...
var onOrderTransactionsChargebackApproved2 = (0, import_event_definition_modules.createEventModule)(
  onOrderTransactionsChargebackApproved
);
var onOrderTransactionsChargebackReversed2 = (0, import_event_definition_modules.createEventModule)(
  onOrderTransactionsChargebackReversed
);
