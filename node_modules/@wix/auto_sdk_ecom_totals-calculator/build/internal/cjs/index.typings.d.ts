...
/** @oneof */
interface CalculateTotalsOptionsCouponOneOf {
    /** Coupon ID. */
    couponId?: string | null;
    /** Coupon code. */
    couponCode?: string | null;
...
/** @oneof */
interface CalculateTotalsOptionsGiftCardOneOf {
    /**
     * Gift card ID.
     * @format GUID
     * @deprecated Gift card ID.
