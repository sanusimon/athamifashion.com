 ...
 * @requiredField query
 */
declare function typedQueryDraftOrders(query: DraftOrderQuery): Promise<NonNullablePaths<QueryDraftOrdersResponse, `draftOrders` | `draftOrders.${number}.shippingInfo.added` | `draftOrders.${number}.shippingInfo.removed` | `draftOrders.${number}.shippingInfo.shippingInfo.title` | `draftOrders.${number}.buyerInfo.visitorId` | `draftOrders.${number}.buyerInfo.memberId` | `draftOrders.${number}.createdBy.userId` | `draftOrders.${number}.createdBy.appId` | `draftOrders.${number}.status` | `draftOrders.${number}.weightUnit` | `draftOrders.${number}.priceSummary.subtotal.amount` | `draftOrders.${number}.priceSummary.subtotal.formattedAmount` | `draftOrders.${number}.balanceSummary.balance.amount` | `draftOrders.${number}.balanceSummary.balance.formattedAmount` | `draftOrders.${number}.recipientInfo.added` | `draftOrders.${number}.recipientInfo.removed` | `draftOrders.${number}.buyerDetails.added` | `draftOrders.${number}.buyerDetails.removed` | `draftOrders.${number}.billingDetails.added` | `draftOrders.${number}.billingDetails.removed` | `draftOrders.${number}.businessLocationDetails.added` | `draftOrders.${number}.businessLocationDetails.removed` | `draftOrders.${number}.businessLocationDetails.businessLocation._id` | `draftOrders.${number}.businessLocationDetails.businessLocation.name`, 6>>;
interface DraftOrderQuerySpec extends QuerySpec {
    paging: 'cursor';
    wql: [
        {
            fields: ['_createdDate', '_updatedDate', 'status'];
            operators: '*';
            sort: 'BOTH';
        },
        {
...
type CommonQueryWithEntityContext = Query<DraftOrder, DraftOrderQuerySpec>;
