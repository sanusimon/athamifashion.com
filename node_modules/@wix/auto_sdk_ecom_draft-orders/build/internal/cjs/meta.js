...
__export(meta_exports, {
  ...
  EditingStatusOriginal: () => EditingStatus,
  ...
  NonDraftableReasonOriginal: () => NonDraftableReason,
  OrderActionTypeOriginal: () => OrderActionType,
  OrderActivityTypeEnumActivityTypeOriginal: () => OrderActivityTypeEnumActivityType,
  OrderStatusOriginal: () => OrderStatus,
  PaymentOptionTypeOriginal: () => PaymentOptionType,
  PaymentStatusOriginal: () => PaymentStatus,
  PickupDetailsPickupMethodOriginal: () => PickupDetailsPickupMethod,
  ...
  addLineItemsToDraftOrder: () => addLineItemsToDraftOrder2,
  commitDraftOrder: () => commitDraftOrder2,
  createCustomAdditionalFees: () => createCustomAdditionalFees2,
  createCustomDiscounts: () => createCustomDiscounts2,
  createDraftOrder: () => createDraftOrder2,
  createEmptyDraftOrder: () => createEmptyDraftOrder2,
  createOrderFromDraft: () => createOrderFromDraft2,
  deleteCustomAdditionalFees: () => deleteCustomAdditionalFees2,
  deleteCustomDiscounts: () => deleteCustomDiscounts2,
  deleteDraftOrder: () => deleteDraftOrder2,
  getDraftOrder: () => getDraftOrder2,
  getOrderDraftabilityStatus: () => getOrderDraftabilityStatus2,
  queryDraftOrders: () => queryDraftOrders2,
  setAdditionalFees: () => setAdditionalFees2,
  ...
  setTaxExemption: () => setTaxExemption2,
...
// src/ecom-v1-draft-order-draft-orders.types.ts
...
// src/ecom-v1-draft-order-draft-orders.meta.ts
function createDraftOrder2() {
  const payload = {};
  const getRequestOptions = createDraftOrder(payload);
...
function createEmptyDraftOrder2() {
  const payload = {};
  const getRequestOptions = createEmptyDraftOrder(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function addLineItemsToDraftOrder2() {
  const payload = { draftOrderId: ":draftOrderId" };
  const getRequestOptions = addLineItemsToDraftOrder(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function setDeposit2() {
  const payload = { draftOrderId: ":draftOrderId" };
  const getRequestOptions = setDeposit(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function setDiscounts2() {
  const payload = { draftOrderId: ":draftOrderId" };
  const getRequestOptions = setDiscounts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function createCustomDiscounts2() {
  const payload = { draftOrderId: ":draftOrderId" };
  const getRequestOptions = createCustomDiscounts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteCustomDiscounts2() {
  const payload = { draftOrderId: ":draftOrderId" };
  const getRequestOptions = deleteCustomDiscounts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function setAdditionalFees2() {
  const payload = { draftOrderId: ":draftOrderId" };
  const getRequestOptions = setAdditionalFees(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function createCustomAdditionalFees2() {
  const payload = { draftOrderId: ":draftOrderId" };
  const getRequestOptions = createCustomAdditionalFees(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteCustomAdditionalFees2() {
  const payload = { draftOrderId: ":draftOrderId" };
  const getRequestOptions = deleteCustomAdditionalFees(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function setShippingInfo2() {
  const payload = {};
  const getRequestOptions = setShippingInfo(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function setBuyerInfo2() {
  const payload = {};
  const getRequestOptions = setBuyerInfo(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function setRecipientInfo2() {
  const payload = {};
  const getRequestOptions = setRecipientInfo(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function setBillingInfo2() {
  const payload = {};
  const getRequestOptions = setBillingInfo(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getDraftOrder2() {
  const payload = { draftOrderId: ":draftOrderId" };
  const getRequestOptions = getDraftOrder(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getOrderDraftabilityStatus2() {
  const payload = { orderId: ":orderId" };
  const getRequestOptions = getOrderDraftabilityStatus(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function commitDraftOrder2() {
  const payload = { draftOrderId: ":draftOrderId" };
  const getRequestOptions = commitDraftOrder(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function createOrderFromDraft2() {
  const payload = { draftOrderId: ":draftOrderId" };
  const getRequestOptions = createOrderFromDraft(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteDraftOrder2() {
  const payload = { draftOrderId: ":draftOrderId" };
  const getRequestOptions = deleteDraftOrder(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function queryDraftOrders2() {
  const payload = {};
  const getRequestOptions = queryDraftOrders(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function setTaxExemption2() {
  const payload = {};
  const getRequestOptions = setTaxExemption(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function setBusinessLocation2() {
  const payload = {};
  const getRequestOptions = setBusinessLocation(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
0 && (module.exports = {
  ...
  commitDraftOrder,
  createCustomAdditionalFees,
  createCustomDiscounts,
  createDraftOrder,
  createEmptyDraftOrder,
  createOrderFromDraft,
  deleteCustomAdditionalFees,
