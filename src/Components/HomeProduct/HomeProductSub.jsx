        ...
        <div className="product_page">
                <div className="inner_">
                    ...
                    <Link className="add_cart" href={`/list?cat=kurtis-1`}>
                        View All
                    </Link>):  categoryId === "dc8664cc-0416-88f9-059f-6c32cbfc9ade" ? 
                    (
                    <Link className="add_cart" href={`/list?cat=top-dupatta`}>
                        View All
                    </Link>):  categoryId === "1bcab2fd-43bb-59e2-daed-6ac0d422924b" ? 
                    (
                    <Link className="add_cart" href={`/list?cat=salwar-suit`}>
                        View All
                    </Link>) : ""}
