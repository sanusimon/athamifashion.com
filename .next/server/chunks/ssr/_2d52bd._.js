...
;
;
const Filter = async ({ onCategoryClick })=>{
    // const {category} = useContext(CategoryApiContext);
    ...
    const filtercat = await wixClient.collections.queryCollections().find();
...
//# sourceMappingURL=_2d52bd._.js.map